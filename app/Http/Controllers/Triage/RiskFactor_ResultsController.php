...
use App\Http\Controllers\Objects\RiskFactorExistingValueObj;
        ...
        try {
            ...
            if(isset( $last_date_record)){
                ...
                foreach($list_of_categories as $category){
                    ...
                    $category_obj = new RiskFactorExistingValueObj;
                    ...
                    foreach($last_record_list as $record){
                        ...
                        if($record['category_id'] == $category_obj['category_id']){
                            ...
                            $result_obj = new RiskFactorExistingValueObj;
